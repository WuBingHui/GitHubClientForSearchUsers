package com.anthony.wu.github.client.search.user.widget
...
class CustomLoadingDialog : DialogFragment(){
    ...
    var outsideAnimation =
        RotateAnimation(outsideFormDegrees, outsideToDegrees, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f)
    var insideAnimation =
        RotateAnimation(insideFormDegrees, insideToDegrees, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f)
    ...
    private fun startInsideAnimation() {
        ...
        wheelInsideImg.animation = insideAnimation
    ...
    private fun startOutsideAnimation() {
        ...
        wheelOutsideImg.animation = outsideAnimation
